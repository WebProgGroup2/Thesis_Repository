<?php
// OPTIONAL: Start PHP session if needed
// session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="sidebar__content">
                ...
                <div class="sidebar__section sidebar__section--topics">
                    ...
                    <ul class="sidebar__list sidebar__list--topics">
                        <li class="sidebar__list-item">Mental Health</li>
    ...
    <div class="searchbar">
        <!-- Fixed form -->
        <form class="searchbar__form" action="javascript:void(0);">
            <input type="text" id="searchInput" class="searchbar__input" placeholder="Search here" name="q">
            <button type="button" id="searchBtn" class="searchbar__button">SEARCH</button>
        </form>

        <!-- Tag container for displaying search keywords -->
        <div id="searchTags" class="search-tags"></div>

        <!-- Dropdown filter menu -->
        <div class="dropdown">
            <button class="searchbar__filter" title="Filter">
                <span class="searchbar__filter-icon">
            ...
            <div class="footer">
                <div class="footer__section">
                    <div class="footer__info">
                        ...
                        <p class="footer__text">nulagunalrc@gamil.com</p>
                    ...
                    <div class="footer__branding">
                        ...
                        <div class="developers">
                            <p class="footer__developers">
                                Developers: Arestado Ted Carlo - Calara Christian - Manalo Caleb Hope - Moises Paule - Chelsea Perez
                            </p>
                        </div>
                    </div>
